...
//		String game;
//		System.out.println("가위바위보 입력하세요 >");
//		game = scanner.next();
//		
//		switch(game) {
//		case "가위":
//			System.out.println("이기기 위해서 바위를 내야합니다.");
//			break;
//		case "바위":
//			System.out.println("이기기 위해서 보를 내야합니다.");
//			break;		
//		case "보":
//			System.out.println("이기기 위해서 가위를 내야합니다.");
//			break;
//		}
		...
		int m;
		int n;
		System.out.println("구구단 m단? >");
		m = scanner.nextInt();
		System.out.println("n까지 곱하기? >");
		n = scanner.nextInt();
